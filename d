...
DDEESSCCRRIIPPTTIIOONN
       ...
       the working tree, in which case HEAD is "detached" as described in ggiitt--
       cchheecckkoouutt(1)).

       The content to be committed can be specified in several ways:

        1. by using ggiitt--aadddd(1) to incrementally "add" changes to the index
           before using the _c_o_m_m_i_t command (Note: even modified files must be
           "added");

        2. by using ggiitt--rrmm(1) to remove files from the working tree and the
           index, again before using the _c_o_m_m_i_t command;

        3. by listing files as arguments to the _c_o_m_m_i_t command (without
        ...
        5. by using the --interactive or --patch switches with the _c_o_m_m_i_t
           ...
           the operation. See the “Interactive Mode” section of ggiitt--aadddd(1) to
           learn how to operate these modes.

       The ----ddrryy--rruunn option can be used to obtain a summary of what is
...
OOPPTTIIOONNSS
       ...
       -c <commit>, --reedit-message=<commit>
           Like _-_C, but with --cc the editor is invoked, so that the user can
           further edit the commit message.

       --fixup=[(amend|reword):]<commit>
           Create a new commit which "fixes up" <<ccoommmmiitt>> when applied with ggiitt
           rreebbaassee ----aauuttoossqquuaasshh. Plain ----ffiixxuupp==<<ccoommmmiitt>> creates a "fixup!"
           commit which changes the content of <<ccoommmmiitt>> but leaves its log
           message untouched.  ----ffiixxuupp==aammeenndd::<<ccoommmmiitt>> is similar but creates
           an "amend!" commit which also replaces the log message of <<ccoommmmiitt>>
           with the log message of the "amend!" commit.
           ----ffiixxuupp==rreewwoorrdd::<<ccoommmmiitt>> creates an "amend!" commit which replaces
           the log message of <<ccoommmmiitt>> with its own log message but makes no
           changes to the content of <<ccoommmmiitt>>.

           The commit created by plain ----ffiixxuupp==<<ccoommmmiitt>> has a subject composed
           of "fixup!" followed by the subject line from <commit>, and is
           recognized specially by ggiitt rreebbaassee ----aauuttoossqquuaasshh. The --mm option may
           ...
           commit is squashed into <<ccoommmmiitt>> by ggiitt rreebbaassee ----aauuttoossqquuaasshh.

           The commit created by ----ffiixxuupp==aammeenndd::<<ccoommmmiitt>> is similar but its
           subject is instead prefixed with "amend!". The log message of
           <commit> is copied into the log message of the "amend!" commit and
           opened in an editor so it can be refined. When ggiitt rreebbaassee
           ----aauuttoossqquuaasshh squashes the "amend!" commit into <<ccoommmmiitt>>, the log
           message of <<ccoommmmiitt>> is replaced by the refined log message from the
           "amend!" commit. It is an error for the "amend!" commit’s log
           message to be empty unless ----aallllooww--eemmppttyy--mmeessssaaggee is specified.

           ----ffiixxuupp==rreewwoorrdd::<<ccoommmmiitt>> is shorthand for ----ffiixxuupp==aammeenndd::<<ccoommmmiitt>>
           ----oonnllyy. It creates an "amend!" commit with only a log message
           (ignoring any changes staged in the index). When squashed by ggiitt
           rreebbaassee ----aauuttoossqquuaasshh, it replaces the log message of <<ccoommmmiitt>>
           without making any other changes.

           Neither "fixup!" nor "amend!" commits change authorship of <<ccoommmmiitt>>
           when applied by ggiitt rreebbaassee ----aauuttoossqquuaasshh. See ggiitt--rreebbaassee(1) for
           details.

       --squash=<commit>
           Construct a commit message for use with rreebbaassee ----aauuttoossqquuaasshh. The
       ...
       --short
           ...
           ssttaattuuss(1) for details. Implies ----ddrryy--rruunn.
       ...
       --porcelain
           ...
           See ggiitt--ssttaattuuss(1) for details. Implies ----ddrryy--rruunn.
       ...
       -z, --null
           When showing sshhoorrtt or ppoorrcceellaaiinn status output, print the filename
           verbatim and terminate the entries with NUL, instead of LF. If no
           format is given, implies the ----ppoorrcceellaaiinn output format. Without the
           --zz option, filenames with "unusual" characters are quoted as
       ...
       --author=<author>
           ...
           standard AA UU TThhoorr <<aauutthhoorr@@eexxaammppllee..ccoomm>> format. Otherwise <author>
       ...
       -m <msg>, --message=<msg>
           Use the given <msg> as the commit message. If multiple --mm options
       ...
       -t <file>, --template=<file>
           ...
           in the given file. The ccoommmmiitt..tteemmppllaattee configuration variable is
           ...
           means, e.g. with the --mm or --FF options.

       -s, --signoff, --no-signoff
           Add a SSiiggnneedd--ooffff--bbyy trailer by the committer at the end of the
           ...
           hhttttpp::////ddeevveellooppeerrcceerrttiiffiiccaattee..oorrgg for the one used by the Linux
       ...
       --trailer <token>[(=|:)<value>]
           ...
           trailer. (e.g.  ggiitt ccoommmmiitt ----ttrraaiilleerr ""SSiiggnneedd--ooffff--bbyy::CC OO MMiitttteerr \\
           <<ccoommmmiitttteerr@@eexxaammppllee..ccoomm>>"" ----ttrraaiilleerr ""HHeellppeedd--bbyy::CC OO MMiitttteerr \\
           <<ccoommmmiitttteerr@@eexxaammppllee..ccoomm>>"" will add the "Signed-off-by" trailer and
           the "Helped-by" trailer to the commit message.) The ttrraaiilleerr..**
           configuration variables (ggiitt--iinntteerrpprreett--ttrraaiilleerrss(1)) can be used to
       ...
       -n, --[no-]verify
           ...
           of ----nnoo--vveerriiffyy or --nn is given, these are bypassed. See also
       ...
       --cleanup=<mode>
           ...
           cleaned up before committing. The _<_m_o_d_e_> can be ssttrriipp, wwhhiitteessppaaccee,
           vveerrbbaattiimm, sscciissssoorrss or ddeeffaauulltt.
           ...
           scissors
               Same as wwhhiitteessppaaccee except that everything from (and including)
           ...
           default
               Same as ssttrriipp if the message is to be edited. Otherwise
               wwhhiitteessppaaccee.

           The default can be changed by the ccoommmmiitt..cclleeaannuupp configuration
           variable (see ggiitt--ccoonnffiigg(1)).

       -e, --edit
           The message taken from file with --FF, command line with --mm, and from
           commit object with --CC are usually used as the commit log message
       ...
       --no-edit
           ...
           example, ggiitt ccoommmmiitt ----aammeenndd ----nnoo--eeddiitt amends a commit without
           changing its commit message.

       --amend
           Replace the tip of the current branch by creating a new commit. The
           recorded tree is prepared as usual (including the effect of the --ii
           and --oo options and explicit pathspec), and the message from the
           ...
           via options such as --mm, --FF, --cc, etc. The new commit has the same
           parents and author as the current one (the ----rreesseett--aauutthhoorr option
       ...
       -o, --only
           ...
           operation of _g_i_t _c_o_m_m_i_t if any paths are given on the command line,
           in which case this option can be omitted. If this option is
           specified together with ----aammeenndd, then no paths need to be
           ...
           with ----aallllooww--eemmppttyy paths are also not required, and an empty commit
           will be created.

       --pathspec-from-file=<file>
           Pathspec is passed in <<ffiillee>> instead of commandline args. If <<ffiillee>>
       ...
       -v, --verbose
           ...
           Note that this diff output doesn’t have its lines prefixed with _#.
           This diff will not be a part of the commit message. See the
           ccoommmmiitt..vveerrbboossee configuration variable in ggiitt--ccoonnffiigg(1).
       ...
       -S[<keyid>], --gpg-sign[=<keyid>], --no-gpg-sign
           ...
           option without a space.  ----nnoo--ggppgg--ssiiggnn is useful to countermand
           both ccoommmmiitt..ggppggSSiiggnn configuration variable, and earlier ----ggppgg--ssiiggnn.
...
EEXXAAMMPPLLEESS
       ...
       but not in the working tree, to that of the last commit with ggiitt
       rreessttoorree ----ssttaaggeedd <<ffiillee>>, which effectively reverts _g_i_t _a_d_d and prevents
       ...
       ggiitt ccoommmmiitt (without any pathname parameter) is used to record what has
       ...
       Instead of staging files after each individual change, you can tell ggiitt
       ccoommmmiitt to notice the changes to the files whose contents are tracked in
       your working tree and do corresponding ggiitt aadddd and ggiitt rrmm for you. That
       ...
       The command ggiitt ccoommmmiitt --aa first looks at your working tree, notices
       that you have modified hello.c and removed goodbye.c, and performs
       necessary ggiitt aadddd and ggiitt rrmm for you.

       After staging changes to many files, you can alter the order the
       changes are recorded in, by giving pathnames to ggiitt ccoommmmiitt. When
       ...
       This makes a commit that records the modification to MMaakkeeffiillee. The
       changes staged for hheelllloo..cc and hheelllloo..hh are not included in the
       ...
       this second commit would record the changes to hheelllloo..cc and hheelllloo..hh as
       expected.
       ...
       After resolving conflicts and staging the result, ggiitt llss--ffiilleess --uu would
       stop mentioning the conflicted path. When you are done, run ggiitt ccoommmmiitt
       to finally record the merge:

           $ git commit

       As with the case to record your own changes, you can use --aa option to
       save typing. One difference is that during a merge resolution, you
       cannot use ggiitt ccoommmmiitt with pathnames to alter the order the changes are
       committed, because the merge should be recorded as a single commit. In
       fact, the command refuses to run when given pathnames (but see --ii
       option).
...
CCOOMMMMIITT IINNFFOORRMMAATTIIOONN
       ...
       has no effect on authentication; for that, see the ccrreeddeennttiiaall..uusseerrnnaammee
       variable in ggiitt--ccoonnffiigg(1).

       In case (some of) these environment variables are not set, the
       information is taken from the configuration items uusseerr..nnaammee and
       uusseerr..eemmaaiill, or, if not present, the environment variable EMAIL, or, if
       that is not set, system user name and the hostname used for outgoing
       mail (taken from //eettcc//mmaaiillnnaammee and falling back to the fully qualified
       hostname when that file does not exist).

       The aauutthhoorr..nnaammee and ccoommmmiitttteerr..nnaammee and their corresponding email
       options override uusseerr..nnaammee and uusseerr..eemmaaiill if set and are overridden
       themselves by the environment variables.

       The typical usage is to set just the uusseerr..nnaammee and uusseerr..eemmaaiill
       variables; the other options are provided for more complex use cases.

DDAATTEE FFOORRMMAATTSS
       The GGIITT__AAUUTTHHOORR__DDAATTEE and GGIITT__CCOOMMMMIITTTTEERR__DDAATTEE environment variables
       support the following date formats:

       Git internal format
           It is <<uunniixx ttiimmeessttaammpp>> <<ttiimmee zzoonnee ooffffsseett>>, where <<uunniixx ttiimmeessttaammpp>>
           is the number of seconds since the UNIX epoch.  <<ttiimmee zzoonnee ooffffsseett>>
           is a positive or negative offset from UTC. For example CET (which
           is 1 hour ahead of UTC) is ++00110000.

       RFC 2822
           The standard email format as described by RFC 2822, for example
           TThhuu,, 0077 AApprr 22000055 2222::1133::1133 ++00220000.

       ISO 8601
           Time and date specified by the ISO 8601 standard, for example
           22000055--0044--0077TT2222::1133::1133. The parser accepts a space instead of the TT
           character as well. Fractional parts of a second will be ignored,
           for example 22000055--0044--0077TT2222::1133::1133..001199 will be treated as
           22000055--0044--0077TT2222::1133::1133.

               NNoottee
               In addition, the date part is accepted in the following
               formats: YYYYYYYY..MMMM..DDDD, MMMM//DDDD//YYYYYYYY and DDDD..MMMM..YYYYYYYY.

       In addition to recognizing all date formats above, the ----ddaattee option
...
EENNVVIIRROONNMMEENNTT AANNDD CCOONNFFIIGGUURRAATTIIOONN VVAARRIIAABBLLEESS
       ...
       GGIITT__EEDDIITTOORR environment variable, the core.editor configuration
       variable, the VVIISSUUAALL environment variable, or the EEDDIITTOORR environment
       variable (in that order). See ggiitt--vvaarr(1) for details.

HHOOOOKKSS
       This command can run ccoommmmiitt--mmssgg, pprreeppaarree--ccoommmmiitt--mmssgg, pprree--ccoommmmiitt,
       ppoosstt--ccoommmmiitt and ppoosstt--rreewwrriittee hooks. See ggiitthhooookkss(5) for more
       information.
...
FFIILLEESS
       $$GGIITT__DDIIRR//CCOOMMMMIITT__EEDDIITTMMSSGG
           ...
           ggiitt ccoommmmiitt exits due to an error before creating a commit, any
           commit message that has been provided by the user (e.g., in an
           editor session) will be available in this file, but will be
           overwritten by the next invocation of ggiitt ccoommmmiitt.
...
Git 2.34.1                        04/26/2023                     GIT-COMMIT(1)
